        ...
        <div id="page" class="main">
                        ...
                        <nav class="navbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown nav-item">
                                    <a class="nav-link active" href="javascript:void(0)" data-bs-toggle="dropdown">About Us
                                        <i class="fa-solid fa-chevron-down"></i>
                                    </a>
            ...
            <div class="site-content">
                ...
                <div class="content-wrapper">
                            ...
                            <div class="row justify-content-between">
                                <div class="col-lg-7 mb-5 mb-lg-0">
                                    <div class="d-flex flex-column justify-content-between h-100">
                                        <div class="section-title wow fadeInUp" data-duration="0.1s" data-delay="0.25s">
                                            <span class="sub-title">[ THE BEST WAY TO SUCCESS ]</span>
                                            <h2 class="title"> NOT JUST WELL-KNOWN…. WE’LL MAKE YOU FAMOUS</h2>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="counter counter-style-1 pgsDownToUP wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1500ms">
                                                    <div class="counter-number">
                                                        <span class="timer mb-0" data-to="95" data-speed="2000">95k</span>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="counter counter-style-1 pgsDownToUP wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1500ms">
                                                    <div class="counter-number">
                                                        <span class="timer mb-0" data-to="850" data-speed="2000">850</span>
                                                        <span class="suffix">+</span>
                                                    </div>
                                                    <div class="counter-info">
                    ...
                    <!-- Start Services Fancy -->
                    <section>
                        <div class="bg-dark space-ptb rounded-section overflow-hidden">
                            <div class="container">
                                <div class="row align-items-center section-title-horizontal wow fadeInUp" data-duration="0.1s" data-delay="0.25s">
                                    <div class="col-xxl-4 col-lg-5 col-md-6">
                                        <div class="section-title">
                                            <span class="sub-title">[ We Are Awesome ]</span>
                                            <h2 class="title">Why Choose Us</h2>
                                        </div>
                                    </div>
                                    <div class="col-xxl-8 col-lg-7 col-md-6 text-md-end">
                                        <a href="service" class="btn"> All Services
                                            <svg fill="#ffffff" width="18px" height="18px" viewBox="0 0 32 32">
                                                <path d="M30.713 16.090c0.009-0.041 0.014-0.087 0.014-0.135 0-0.004-0-0.008-0-0.011v0.001c-0.006-0.184-0.079-0.35-0.196-0.475l0 0-10-10c-0.136-0.135-0.323-0.218-0.529-0.218-0.415 0-0.751 0.336-0.751 0.751 0 0.206 0.083 0.393 0.218 0.528l8.721 8.72h-26.189c-0.414 0-0.75 0.336-0.75 0.75s0.336 0.75 0.75 0.75v0h26.188l-8.72 8.719c-0.136 0.136-0.22 0.324-0.22 0.531 0 0.415 0.336 0.751 0.751 0.751 0.207 0 0.395-0.084 0.531-0.22l10-10.001c0.025-0.026 0.017-0.064 0.038-0.093 0.040-0.052 0.098-0.088 0.124-0.151 0.013-0.050 0.020-0.108 0.020-0.167 0-0.011-0-0.021-0.001-0.032l0 0.002z"/>
                                            </svg>
                                        </a>
                                ...
                                <div class="row mt-5 mt-md-0">
                                    <div class="col-md-12">
                                        <div class="services-slider-section pt-0">
                                            <div class="services-bg-slider wow fadeInUp" data-duration="0.1s" data-delay="0.25s">
                                                ...
                                                <div class="services-bg-slider-content">
                                                    <h3 class="title">Elevate Your Marketing Strategy</h3>
                                                    <a href="case-studies" class="btn">Read Case Study</a>
                                                </div>
                                            </div>
                                            <div class="services-boxs service-fancy grid-wrapper grid-xl-1 grid-lg-1 grid-md-1 grid-sm-1">
                                                    ...
                                                    <div class="service-content">
                                                        <div class="service-content-inner">
                                                            <div class="service-info">
                                                                <h2 class="service-number">01</h2>
                                                                <h3 class="service-title">Client First</h3>
                                                            </div>
                                                ...
                                                <div class="service-item service-fancy-item wow fadeInUp" data-duration="0.1s" data-delay="0.25s">
                                                    ...
                                                    <div class="service-content">
                                                        <div class="service-content-inner">
                                                            <div class="service-info">
                                                                <h2 class="service-number">02</h2>
                                                                <h3 class="service-title">Effective Synergy</h3>
                                                            </div>
                                ...
                                <div class="col-lg-6 col-xxl-5">
                                    <div class="is-sticky" style="top: 100px;">
                                        <div class="section-title mb-0 wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                                            ...
                                            <h2 class="title">The Evolution of Our Organization's Journey</h2>
                                            <p class="p-black">Business marketing involves strategies and activities that promote and sell products or services to target audiences.</p>
                                            <a class="btn" href="portfolio"> See Our Projects
                                                <svg fill="#ffffff" width="18px" height="18px" viewBox="0 0 32 32">
                                                    <path d="M30.713 16.090c0.009-0.041 0.014-0.087 0.014-0.135 0-0.004-0-0.008-0-0.011v0.001c-0.006-0.184-0.079-0.35-0.196-0.475l0 0-10-10c-0.136-0.135-0.323-0.218-0.529-0.218-0.415 0-0.751 0.336-0.751 0.751 0 0.206 0.083 0.393 0.218 0.528l8.721 8.72h-26.189c-0.414 0-0.75 0.336-0.75 0.75s0.336 0.75 0.75 0.75v0h26.188l-8.72 8.719c-0.136 0.136-0.22 0.324-0.22 0.531 0 0.415 0.336 0.751 0.751 0.751 0.207 0 0.395-0.084 0.531-0.22l10-10.001c0.025-0.026 0.017-0.064 0.038-0.093 0.040-0.052 0.098-0.088 0.124-0.151 0.013-0.050 0.020-0.108 0.020-0.167 0-0.011-0-0.021-0.001-0.032l0 0.002z"/>
                                                </svg>
                                            </a>
