				...
				<section>
					<div class="inner-banner bg-holder rounded-section jarallax">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<h1 class="title text-white">Google ADS & PPC</h1>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="sidebar service-sidebar is-sticky">
										<div class="widget widget-menu menu-style-2 wow fadeInUp glass" data-wow-delay="0.1s" data-wow-duration="1500ms">
											...
											<ul>
												...
												<li>
													<a href="paid-marketing" class="active">PPC Managment Services</a>
												</li>
												<li>
                                            ...
                                            <div class="accordion accordion-style-pgs-two wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms" id="pgsaccordion">
                                                <div class="accordion-item">
                                                    <h4 class="accordion-header" id="headingOne">
                                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">01. What is unique with the PPC management services of DigiTroopers?</button>
                                                    </h4>
                                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#pgsaccordion">
                                                        <div class="accordion-body">We apply AI-powered analytics and real-time optimization of keywords to enhance the click through rates, decrease the amount of ad money and achieve ROI.</div>
                                                    </div>
                                                </div>
                                                <div class="accordion-item">
                                                    <h4 class="accordion-header" id="headingTwo">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> 02. What is the role of PPC marketing in increasing my business in the USA? </button>
                                                    </h4>
                                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#pgsaccordion">
                                                        <div class="accordion-body">Our PPC management will make sure that your brand is seen in the right spots with targeted ad placements and conversion tracking forming high quality leads and quicker growth. </div>
                                                    </div>
                                                </div>
                                                <div class="accordion-item">
                                                    <h4 class="accordion-header" id="headingThree">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">03. DigiTroopers deal with Google Ads and other paid services?</button>
                                                    </h4>
                                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#pgsaccordion">
                                                        <div class="accordion-body">Yes - we handle Google Ads, Bing Ads, YouTube Ads, and social PPC campaigns on Facebook, LinkedIn, and Instagram to be able to accomplish full paid success.</div>
                                                    </div>
                                                </div>
                                                <div class="accordion-item">
                                                    <h4 class="accordion-header" id="headingFour">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">04.When will I see the results of the PPC campaigns?</button>
                                                    </h4>
                                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#pgsaccordion">
                                                        <div class="accordion-body">Our AI-based bid management and real-time performance optimization help most of the clients achieve better impressions and conversions within 244 weeks.</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="case-studies-info">
                                                    <div class="case-studies-info-inner">
                                                        <h3 class="case-studies-title">
                                                            <a href="javascript:void(0);">Mosemagi</a>
                                                        </h3>
                                        ...
                                        <div class="grid-item" data-groups='["graphic"]'>
                                            <div class="case-studies-wrapper case-studies-style-1">
                                                ...
                                                <div class="case-studies-info">
                                                    <div class="case-studies-info-inner">
                                                        <h3 class="case-studies-title">
                                                            <a href="javascript:void(0);">AppNation</a>
                                                        </h3>
                                                        <div class="case-studies-content">
                                                            <div class="case-studies-description">Graphic</div>
                                                        </div>
