						...
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-6 mt-4 mt-md-5 mt-lg-0">
									<div class="contact-us-form ps-xl-4">
										...
										<form class="contact-form form-style-border wow fadeInUp" id="contactForm" data-wow-delay="0.1s" data-wow-duration="1500ms">
											<div class="row">
												...
												<div class="col-md-6">
													<input type="tel" class="form-control" placeholder="Phone *" aria-label="Phone" name="phone" maxlength="11">
												</div>
												<div class="col-md-6">
													<input type="text" class="form-control" placeholder="Subject *" aria-label="Subject" name="subject">
												</div>
												<div class="col-md-12">
													<textarea class="form-control" placeholder="Write Message" rows="4" name="message"></textarea>
												</div>
												<div class="col-md-12">
