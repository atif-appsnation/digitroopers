...
<body>
	...
	<div id="page" class="main">
				...
				<div class="body-inner h-100 pe-3 lenis-scroll-disable">
					<nav class="navbar">
						<ul class="nav navbar-nav">
							...
							<li class="nav-item">
								<a class="nav-link" href="iortfolio">
									<span>Portfolio</span>
								</a>
							</li>
							<li class="nav-item">
		...
		<!-- End Right menu -->
		<!-- Modal -->
		<div class="modal fade social-share-modal" id="socialModal" tabindex="-1" aria-labelledby="socialModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-header">
						<p class="modal-title" id="socialModalLabel">Share This</p>
						<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i class="fa-solid fa-xmark"></i></button>
					</div>
					<div class="modal-body">
						<div class="social-share-dialog">
							<ul class="social-share-items">
								<li class="social-share-item social-service social-service-facebook"> <a href="#" target="_blank" title="Facebook">Fa.</a> </li>
								<li class="social-share-item social-service social-service-twitter"> <a href="#" target="_blank" title="Twitter">Tw.</a> </li>
								<li class="social-share-item social-service social-service-linkedin"> <a href="#" target="_blank" title="LinkedIn">Li.</a> </li>
								<li class="social-share-item social-service social-service-pinterest"> <a href="#" target="_blank" title="Pinterest">Pi.</a> </li>
								<li class="pgs-social-share-item social-service social-service-whatsapp"> <a href="#" target="_blank" title="WhatsApp">Wh.</a> </li>
								<li class="pgs-social-share-item social-service social-service-telegram"> <a href="#" target="_blank" title="Telegram">Tg.</a> </li>
							</ul>
						</div>
					</div>
				</div>
			...
			<section>
				<div class="inner-banner bg-holder rounded-section jarallax">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1 class="title text-white">Insights</h1>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-xl-9">
								<div id="blogs" class="blogs blog-standard grid-wrapper grid-xl-1 grid-lg-1 grid-md-1 grid-sm-1">
									<!-- Blog post yahan repeat honge JS ke through -->
								</div>
							</div>
							<div class="col-lg-4 col-xl-3">
								<div class="sidebar mt-4 mt-md-5 mt-lg-0">
									<div class="widget widget-search wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<form class="search">
											<input type="search" id="search-input" class="form-control" placeholder="Search">
											<button type="submit" class="search-btn"><i class="fa-solid fa-magnifying-glass"></i></button>
										</form>
									</div>
									<div class="widget widget-categories wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<h2 class="widget-title">Categories</h2>
										<ul class="categories-list">
											<li> <a href="https://blog.appsnation.co/category/2d-art/">2D Art</a> </li>
											<li> <a href="https://blog.appsnation.co/category/android-app/">Android App</a> </li>
											<li> <a href="https://blog.appsnation.co/category/ai/">AI</a> </li>
											<li> <a href="https://blog.appsnation.co/category/ar-vr-app/">AR & VR Apps</a> </li>
											<li> <a href="https://blog.appsnation.co/category/cyber-security/">cyber security</a> </li>
										</ul>
									</div>
									<div class="widget widget-recent-posts wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<h3 class="widget-title">Recent Posts</h3>
										<div class="recent-posts">
											<div class="posts-img"><img class="img-fluid" src="../assets/images/blog/01.jpg" alt=""></div>
											<div class="post-info"> <a href="blog-single" class="post-title">How to Integrate Marketing Tools into Your Design</a> <span class="post-date">Mar 26, 2024</span> </div>
										</div>
										<div class="recent-posts">
											<div class="posts-img"><img class="img-fluid" src="../assets/images/blog/02.jpg" alt=""></div>
											<div class="post-info"> <a href="blog-single" class="post-title">2024 Top SEO Features for Marketing Designs</a> <span class="post-date">Mar 26, 2024</span> </div>
										</div>
										<div class="recent-posts">
											<div class="posts-img"><img class="img-fluid" src="../assets/images/blog/03.jpg" alt=""></div>
											<div class="post-info"> <a href="blog-single" class="post-title">How can marketing help your business better?</a> <span class="post-date">Mar 26, 2024</span> </div>
										</div>
									</div>
									<div class="widget wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<div class="contact-info-box">
											...
											<ul>
												...
												<li><a href="tel:12535284057">→ +1 (253) 528-4057</a></li>
												<li>USA → 12316 SE 254th Ct Kent, WA 98030, United States</li>
												<hr>
												<li>Saudi Arabia → Floor 3, Building 7264, Ibn Al Fourat, Jareer, P.O 12837 Riyadh, Saudi Arabia</li>
											</ul>
										</div>
									</div>
									<div class="widget tags-widget wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<h5 class="widget-title">Tags</h5>
										<ul class="tag-list">
											<li><a class="" href="#">Agency</a></li>
											<li><a class="" href="#">Branding</a></li>
									...
									<div class="widget widget-newsletter wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<h5 class="widget-title  ">Newsletter</h5>
										<p class="p-black newsletter-description text-black">Just Subscribe and we'll send you a notification by email.</p>
	...
	// ✅ Original API URL
	const BASE_API = 'https://blog.appsnation.co/api/get-blogs-api';
	...
	fetch(proxiedUrl).then(res => {
		...
		blogs.forEach(blog => {
			...
			blogDiv.innerHTML = `
            <div class="blog-post wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                      ...
                      <div class="blog-post-info">
                        ...
                        <p class="p-black description">${blog.post_content_preview}</p>
                      </div>
                      <div class="post-foot">
                        <div class="post-meta">
                          <ul>
                            ...
                            <li class="post-meta-date">
                              <a href="#">${blog.post_date}</a>
                            </li>
                          </ul>
                        </div>
                        <div class="widget-social post-social">
                          <span class="follow-title">Share This</span>
                          <ul class="social-icon">
                            <li><a href="https://www.facebook.com/DigiTroopers/">Fb.</a></li>
                            <li><a href="https://www.instagram.com/digitalmarketingservicesusa/">In.</a></li>
                            <li><a href="https://x.com/Digi_Troopers/">Tw.</a></li>
                            <li><a href="https://www.linkedin.com/company/digitroopers/">Li.</a></li>
                            <li><a href="#" class="social-share" data-bs-toggle="modal" data-bs-target="#socialModal"><i class="fa-solid fa-share-nodes"></i></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
