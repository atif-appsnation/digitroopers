				...
				<section>
					<div class="inner-banner bg-holder rounded-section jarallax">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<h1 class="title text-white">Social Media Marketing</h1>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="sidebar service-sidebar is-sticky">
										<div class="widget widget-menu menu-style-2 wow fadeInUp glass" data-wow-delay="0.1s" data-wow-duration="1500ms">
											...
											<ul>
												...
												<li>
													<a href="social-media-marketing" class="active">Social Media Markrting</a>
												</li>
												<li>
                                        ...
                                        <div class="pricing-box bg-light wow fadeInUp" data-wow-delay="0.1s"
                                            ...
                                            <div class="pricing-content">
                                                <ul class="package-list">
                                                    ...
                                                    <li><i class="fa-regular fa-circle-check"></i><span>10 Monthly Posting </span> </li>
                                        ...
                                        <div class="pricing-box active wow fadeInUp " data-wow-delay="0.3s"
                                            ...
                                            <div class="pricing-content">
                                                <ul class="package-list">
                                                    ...
                                                    <li><i class="fa-regular fa-circle-check"></i><span>15 Monthly posting</span> </li>
                                                    <li><i class="fa-regular fa-circle-check"></i><span>Page Monitoring & Responding</span></li>
                                                    <li><i class="fa-regular fa-circle-check"></i><span>Social media Audit</span></li>
                                                    <li><i class="fa-regular fa-circle-check"></i><span>Content Strategy</span> </li>
                                        ...
                                        <div class="pricing-box bg-light wow fadeInUp" data-wow-delay="0.6s"
                                            ...
                                            <div class="pricing-content">
                                                <ul class="package-list">
                                                    ...
                                                    <li><i class="fa-regular fa-circle-check"></i><span>Market Analysis</span> </li>
                                                    ...
                                                    <li><i class="fa-regular fa-circle-check"></i><span>Chatbot Integration</span> </li>
                                ...
                                <div class="row justify-content-start">
                                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                                        <div class="filters-group mb-2 mb-lg-5">
                                            ...
                                            <button class="btn-filter" data-group="socialmedia">Social Media</button>
                                        </div>
