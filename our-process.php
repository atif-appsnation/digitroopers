        ...
        <div id="page" class="main">
            ...
            <div class="site-content">
                ...
                <section>
                    <div class="inner-banner bg-holder rounded-section jarallax">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1 class="title text-white">About Us - Our Process</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-wrapper">
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-5 text-center">
                                    <img src="assets/images/our-process/development.webp" alt="Idea Analysis" class="img-fluid radius-20 h-auto" loading="lazy">
                                </div>
                    ...
                    <section class="my-4">
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-5 text-center">
                                    <img src="assets/images/our-process/idea-analysis.webp" alt="Idea Analysis" class="img-fluid radius-20 h-auto" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </section>
                    <!-- End Section 1: Idea Analysis -->

                    <!-- Start Section 2: Wireframing and Architectural Planning -->
                    <section class="my-4">
                        <div class="container">
                            <div class="row align-items-center flex-md-row-reverse">
                                ...
                                <div class="col-lg-5 text-center">
                                    <img src="assets/images/our-process/planning.webp" alt="Wireframing" class="img-fluid radius-20 h-auto" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </section>
                    <!-- End Section 2: Wireframing and Architectural Planning -->

                    <!-- Start Section 3: User Interface Design -->
                    <section class="my-4">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-7 text-center text-lg-start mb-4 mb-md-0">
                                ...
                                <div class="col-lg-5 text-center">
                                    <img src="assets/images/our-process/user interface.webp" alt="UI Design" class="img-fluid radius-20 h-auto" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </section>
                    <!-- End Section 3: User Interface Design -->

                    <!-- Start Section 4: Functional Model Development -->
                    <section class="my-4">
                        <div class="container">
                            <div class="row align-items-center flex-md-row-reverse">
                                <div class="col-lg-7 text-center text-lg-start mb-4 mb-md-0">
                    ...
                    <!-- End Section 4: Functional Model Development -->

                    <!-- Start Section 5: Quality Assurance -->
                    <section class="my-4">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-7 text-center text-lg-start mb-4 mb-md-0">
                                ...
                                <div class="col-lg-5 text-center">
                                    <img src="assets/images/our-process/quality-assurance.webp" alt="Quality Assurance" class="img-fluid radius-20 h-auto" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </section>
                    <!-- End Section 5: Quality Assurance -->

                    <!-- Start Section 6: Deployment -->
                    <section class="my-4">
                        <div class="container">
                            <div class="row align-items-center flex-md-row-reverse">
                                <div class="col-lg-7 text-center text-lg-start mb-4 mb-md-0">
                                ...
                                <div class="col-lg-5 text-center">
                                    <img src="assets/images/our-process/deployment.webp" alt="Deployment" class="img-fluid radius-20 h-auto" loading="lazy">
                                </div>
                            </div>
                        </div>
                    </section>
                    <!-- End Section 6: Deployment -->
                    <!-- End About Info -->
                </div>
            </div>
