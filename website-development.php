					...
					<div class="body-inner h-100 pe-3 lenis-scroll-disable">
						<nav class="navbar">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown nav-item">
									<a class="nav-link active" href="javascript:void(0)" data-bs-toggle="dropdown">Services
										<i class="fa-solid fa-chevron-down"></i>
									</a>
				...
				<section>
					<div class="inner-banner bg-holder rounded-section jarallax">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<h1 class="title text-white">Website Development</h1>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row mt-4">
						...
						<div class="col-sm-6 col-md-6 col-lg-3">
							<div class="counter counter-style-1 pgsDownToUP wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1500ms">
								...
								<div class="counter-info counter-number"> <span class="counter-title">Support Available</span>
									<div class="d-flex">
						...
						<div class="container">
							<div class="row justify-content-start">
									...
									<div class="sidebar service-sidebar is-sticky">
										<div class="widget widget-menu menu-style-2 wow fadeInUp glass" data-wow-delay="0.1s" data-wow-duration="1500ms">
											...
											<ul>
												...
												<li>
													<a href="website-development" class="active">Website Development</a>
												</li>
												<li>
								...
								<div class="col-lg-8 mt-5 mt-lg-0 ps-0 ps-md-5">
									...
									<!-- Start CMS Based Websites -->
									<div class="service-single my-4">
										<div class="service-content mt-4 mt-sm-5">
											<h4 class="service-title fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms"> Our Web Development Services </h4>
											<div class="description wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
												<p> We are the best Website Development agency if you are seeking a CMS-based solution for your website. Our Website experts provide you <a href="seo" class="text-primary">SEO-optimized</a>, mobile responsive websites that work with WordPress, Joomla, Shopify, Drupal, Squarespace, Wix, Bitrix, Magento, PrestaShop, OpenCart, and TYPO3. DigiTroopers delivers a seamlessly responsive, data-driven design ensuring that your website attains and maintains high views, click rates, and conversions. </p>
											</div>
										</div>
									...
									<div class="accordion accordion-style-pgs-two wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms" id="pgsaccordion">
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingOne">
												<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">1. Why are DigiTroopers among the top web design and development firms in 2026? </button>
											</h5>
											<div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#pgsaccordion">
												<div class="accordion-body"> We combine creative UI/UX design and powerful backend engineering to deliver websites that work — not just look good. Our 2026 vision leverages AI to analyze user behavior, guiding evidence-based design choices that give your brand a competitive edge. </div>
											</div>
										</div>
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingTwo">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Q2. How does DigiTroopers make my website fast and rank high on Google? </button>
											</h5>
											<div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#pgsaccordion">
												<div class="accordion-body"> We apply Google Core Web Vitals, technical SEO, and performance optimization — including lazy loading, CDN integration, and code compression. Our SEO specialists enhance visibility using schema markup, internal linking, and keyword validation. </div>
											</div>
										</div>
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingThree">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Q3. What are your web design and development packages?</button>
											</h5>
											<div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#pgsaccordion">
												<div class="accordion-body"> DigiTroopers offers three tailored packages — Basic, Professional, and Premium — each including W3C-validated HTML, SSL installation, mobile optimization, and security setup. Advanced packages feature premium themes, animations, and enhanced interaction tools. </div>
											</div>
										</div>
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingFour">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Q4. Should I choose CMS-based or custom web development? </button>
											</h5>
											<div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#pgsaccordion">
												<div class="accordion-body"> We specialize in both CMS-based (WordPress, Shopify, Wix, Magento) and custom websites (HTML, Laravel, Python, .NET). CMS solutions are great for easy management, while custom builds offer greater scalability, flexibility, and long-term performance. </div>
											</div>
										</div>
									</div>
									<!-- End FAQ Section -->
								...
								<div class="row justify-content-start">
									<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<!-- <div class="filters-group mb-2 mb-lg-5">
											...
											<button class="btn-filter" data-group="website">WEBSITE</button>
										</div> -->
											...
											<div class="grid-item" data-groups='["website"]'>
												<div class="case-studies-wrapper case-studies-style-1">
													...
													<div class="case-studies-info">
														<div class="case-studies-info-inner">
															<h3 class="case-studies-title">
																<a href="ride-smart">Ride Smart</a>
															</h3>
															<div class="case-studies-content">
																<div class="case-studies-description">Website</div>
															</div>
											...
											<div class="grid-item" data-groups='["website"]'>
												<div class="case-studies-wrapper case-studies-style-1">
													...
													<div class="case-studies-info">
														<div class="case-studies-info-inner">
															<h3 class="case-studies-title">
																<a href="skyline-estate">Skyline Estae</a>
															</h3>
															<div class="case-studies-content">
																<div class="case-studies-description">Website</div>
															</div>
									...
									<div class="action-box wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
										<div class="client-reviews">
											<ul class="client-profile">
												<li> <img class="img-fluid" src="assets/images/avatar/01.jpg" alt=""> </li>
												<li> <img class="img-fluid" src="assets/images/avatar/02.jpg" alt=""> </li>
												<li> <img class="img-fluid" src="assets/images/avatar/03.jpg" alt=""> </li>
											</ul>
