                ...
                <section>
                    <div class="inner-banner bg-holder rounded-section jarallax">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1 class="title text-white">About Us - Careers</h1>
                                </div>
                            </div>
                        </div>
                    </div>
							  	...
							  	<div class="row justify-content-between">
									<div class="col-xxl-5 col-lg-6">
									    <div class="is-sticky" style="top: 100px;">
											<div class="section-title wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">
												<span class="sub-title">[ Our Creative Services ]</span>
											  	<h2 class="title">We offer great number of finance services</h2>
											  	<p class="p-black text-black">Business marketing involves strategies and activities that promote and sell products or services to target audiences.</p>
											</div>
											<div class="video-wrapper video-style-2 video-dark-overlay bg-holder wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1500ms" style="background-image: url(../assets/images/bg/video-bg-1.jpg);">
												<div class="video-btn-wrapper">
													<a class="video-btn video-btn-style-2 popup-youtube" href="https://www.youtube.com/watch?v=RMBbIuOTC_8">
										...
										<div class="pgsel-history-slider-wrapper">
											<div class="history-items">
												<div class="history-item wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
													...
													<h3 class="history-title">100+ worldwide base</h3>
													<p class="p-black history-content">The best way is to develop and follow a plan. Start with your goals in mind and then work backwards to develop the plan. What steps are required to get you to the goals.</p>
												</div>
												<div class="history-item wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
													<span class="history-number"></span>
												...
												<div class="history-item wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
													...
													<h3 class="history-title">archive 1000+ awards</h3>
													<p class="p-black history-content">The best way is to develop and follow a plan. Start with your goals in mind and then work backwards to develop the plan. What steps are required to get you to the goals.</p>
												</div>
												<div class="history-item wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
													<span class="history-number"></span>
