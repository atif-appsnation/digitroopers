				...
				<section>
					<div class="inner-banner bg-holder rounded-section jarallax">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<h1 class="title text-white">Email Marketing Services</h1>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row justify-content-start">
									...
									<div class="sidebar service-sidebar is-sticky">
										<div class="widget widget-menu menu-style-2 wow fadeInUp glass" data-wow-delay="0.1s" data-wow-duration="1500ms">
											...
											<ul>
												...
												<li>
													<a href="email-marketing" class="active">E-mail Marketing</a>
												</li>
												<li>
								...
								<div class="col-lg-8 mt-5 mt-lg-0 ps-0 ps-md-5">
									<div class="service-single my-5">
										...
										<div class="service-content ps-0 ps-md-5 mt-4 mt-sm-5">
											...
											<div class="description wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
												...
												<p>Email marketing is an extremely cost-effective <a class="text-primary" href="graphic-design"> digital marketing </a> approach that utilizes a solicited and curated list of Email addresses to develop and maintain close relationships with qualified prospects and customers. The primary goal of an effective email marketing strategy is to connect with and convert prospects into customers, eventually winning them over as loyal patrons. People across all demographics prefer email over other permission-based <a class="text-primary" href="./graphic-design"> advertising</a> which is perhaps why Email marketing has the highest ROI relative to other digital marketing methods.</p>
											</div>  
										</div>
									...
									<div class="section-title mt-5 mb-4 mb-sm-5">
										<h4 class="title wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">Frequently Asked Questions</h4>
									</div>
									<div class="accordion accordion-style-pgs-two wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms" id="pgsaccordion">
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingOne">
												<button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">01. What is the difference with the email marketing of DigiTroopers?</button>
											</h5>
											<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#pgsaccordion">
												<div class="accordion-body">DigiTroopers deploys AI and automation to divide viewers, customize emails, and optimize campaigns timing - assisting businesses to improve open and conversion rates.</div>
											</div>
										</div>
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingTwo">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">02. So what is the effectiveness of email marketing as regards to increasing sales? </button>
											</h5>
											<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#pgsaccordion">
												<div class="accordion-body">Email marketing is strategic nurturing of leads that leads to customer confidence and loyalty to the company and converting leads into long-term buyers.</div>
											</div>
										</div>
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingThree">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">03. Is DigiTroopers capable of managing massive campaigns to e-commerce or B2B?</button>
											</h5>
											<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#pgsaccordion">
												<div class="accordion-body">Yes. Our AI-based solutions support and automate large-scale campaigns, both B2B and e-commerce, and offer accuracy and reliable ROI monitoring. </div>
											</div>
										</div>
										<div class="accordion-item">
											<h5 class="accordion-header" id="headingFour">
												<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseThree">04. Do you offer performance reports and analytics?</button>
											</h5>
											<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#pgsaccordion">
												<div class="accordion-body">Absolutely. Our service offers real-time analytics, A/B light, and performance dashboard services, which enable our customers to make decisions based on data and scale at the same time.</div>
											</div>
										</div>
									</div>
								</div>
