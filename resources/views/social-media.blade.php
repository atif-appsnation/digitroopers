        ...
        <div class="row ">
            <div class="col-sm-12 col-md-12 col-lg-6 my-auto">
                <div class="bread-titlev2">
                    <h5>Get Engaged, Get Influenced, Get Business</h5>
                    <h2>Social Media Marketing that Works</h2>
...
<section class="services bg-gradient4 py-5">
    <div class="container">
        ...
        <div class="row upset link-hover">
            <div class="col-lg-6 col-sm-6 mt30 wow">
...
<section class="featured-project bg-gradient1 py-5">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-6">
                <div class="common-heading ptag">
                    <div class="sctxt">Our Projects</div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 wow" data-wow-delay=".2s">
