...
<section class="breadcrumb-area banner-ourprocess">
...
<section class="service-block py-5">
	<div class="container">
		<div class="row justify-content-center text-center">
			<div class="col-lg-8">
                <div class="sctxt">Our Process</div>
		...
		<div class="row upset justify-content-center mt60">
			<div class="col-lg-5">
                <img src="images/process/idea-analysis.webp" alt="Process" class="img-fluid" />
			</div>
		...
		<div class="row upset justify-content-center mt60">
			<div class="col-lg-7 my-auto">
				<div class="ps-block">
                    <span>2</span>
					<h3>Wireframing and Architectural Planning</h3>
					<p>Using the information gathered from stage one, it is time to arrange it together and create a detailed website plan. After gathering sufficient information about the business, it's time to create the sitemaps and wireframes.
					<br> With the information collected in the first stage, a sitemap is created. The primary motive of a site map is to create a user-friendly website and creates a structure for the site, and it assists in organizing your site so that it is easy to navigate and place any additional pages as they are created.
					<br>A wireframe is a visual representation of the user interface. It provides a visual description of a site. This step can be a daunting task to set up your business website, but if you know what you want to achieve, the process will go quickly.</p>
				</div>
			</div>
			<div class="col-lg-5">
                <img src="images/process/wireframing-and-architectural-planning.webp" alt="Process" class="img-fluid" />
			</div>
		</div>
		<div class="row upset justify-content-center mt60">
			<div class="col-lg-5">
                <img src="images/process/user-interface-design.webp" alt="Process" class="img-fluid" />
			</div>
			<div class="col-lg-7 my-auto">
				<div class="ps-block">
                    <span>3</span>
		...
		<div class="row upset justify-content-center mt60">
			<div class="col-lg-7">
				<div class="ps-block"> <span>4</span>
					<h3>Functional Model Development</h3>
			...
			<div class="col-lg-5">
                <img src="images/process/functional-model-development.webp" alt="Process" class="img-fluid" />
			</div>
		</div>
		<div class="row upset justify-content-center mt60">
			<div class="col-lg-5">
                <img src="images/process/quality-assurance.webp" alt="Process" class="img-fluid" />
			</div>
			<div class="col-lg-7">
				<div class="ps-block"> <span>5</span>
		...
		<div class="row upset justify-content-center mt60">
			<div class="col-lg-7">
				<div class="ps-block"> <span>6</span>
					<h3>Deployment</h3>
